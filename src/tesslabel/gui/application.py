...
from tesslabel import __version__

from tesslabel.logger import setLogLevel
from tesslabel.gui import ABOUT_DESC_TXT, ABOUT_ACK_TXT, ABOUT_IMG, ABOUT_ICONS
from tesslabel.gui.preferences import Preferences
from tesslabel.gui.widgets.contrib import ToolTip
from tesslabel.gui.widgets.mainpanel import PhotometerPanel, CalibrationPanel, BatchManagemetPanel
from tesslabel.gui.widgets.about import AboutDialog
from tesslabel.gui.widgets.writezp import WriteZeroPointDialog
...
class Application(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title(f'TESS LABEL {__version__}')
