...
from tesslabel.gui.preferences.refphot import RefPhotometerFrame
from tesslabel.gui.preferences.testphot import TestPhotometerFrame

# from tesslabel.gui.preferences.test import TestPhotometerFrame
